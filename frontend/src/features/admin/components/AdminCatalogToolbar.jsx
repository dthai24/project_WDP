...
import { ADMIN_CATALOG_STATUS_FILTER_OPTIONS } from '@/features/admin/data/adminCatalogConstants';
...
export default function AdminCatalogToolbar({
  ...
  const CountIconComponent = CountIcon;
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 1 }}>
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.75, flex: 1, minWidth: 0 }}>
          <FilterTrigger
            ...
            label={statusLabel}
            hasValue={statusFilter !== statusDefault}
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexShrink: 0 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, px: 0.5 }}>
            {CountIconComponent ? (
              <CountIconComponent sx={{ fontSize: 14, color: '#0891B2' }} />
            ) : null}
            <Typography
              variant="caption"
